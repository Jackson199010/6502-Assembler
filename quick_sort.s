...
sta $02  ; Store lo at TMP1 
lda #$05 ; Hi index
sta $03  ; Store hi at TMP2 

jsr LOMUTO_PARTITION
jmp END

; Swap the values that stored by the index in Y registry and the SWAP_IND
SWAP:
...
LOMUTO_PARTITION:
  ...
  END_LOMUTO_PARTITION:
    ...
    ; The expected array after first partition must be [ 1, 5, 8, 9, a, 7 ] 
END: